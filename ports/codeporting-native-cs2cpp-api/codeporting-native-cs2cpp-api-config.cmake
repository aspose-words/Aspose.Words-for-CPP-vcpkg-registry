...
elseif (VCPKG_TARGET_TRIPLET STREQUAL "x64-osx")
  set(_SUFFIX "_appleclang13")
elseif (VCPKG_TARGET_TRIPLET STREQUAL "x64-linux")
  set(_SUFFIX "_x86_64_libstdcpp_libc2.23")
endif()

set(_IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/${CMAKE_IMPORT_LIBRARY_PREFIX}aspose_cpp${_SUFFIX}${CMAKE_IMPORT_LIBRARY_SUFFIX}")
set(_IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/${CMAKE_SHARED_LIBRARY_PREFIX}aspose_cpp${_SUFFIX}${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(_IMPORTED_SONAME "${CMAKE_SHARED_LIBRARY_PREFIX}aspose_cpp${_SUFFIX}${CMAKE_SHARED_LIBRARY_SUFFIX}") 
set(_IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/debug/lib/${CMAKE_IMPORT_LIBRARY_PREFIX}aspose_cpp${_SUFFIX}d${CMAKE_IMPORT_LIBRARY_SUFFIX}")
set(_IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/${CMAKE_SHARED_LIBRARY_PREFIX}aspose_cpp${_SUFFIX}d${CMAKE_SHARED_LIBRARY_SUFFIX}")
